 ...
 *
 * Each helper is fire-and-forget: errors are swallowed (logged as warnings)
 * so calling haptics from UI handlers never disrupts user actions.
 *
 * @example
 *   import { impactLight, notificationSuccess } from '@/lib/haptics';
 *
 *   <Button onClick={() => { impactLight(); doThing(); }}>Tap me</Button>
 */
...
/** Heavy tap — game button press, destructive confirmation. */
